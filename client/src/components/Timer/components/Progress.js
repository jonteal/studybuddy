  ...
  return (
    <div className="pg-container">
      ...
      <Pgwidget>
        ...
        <Circle>
          <PgwidgetBarL>
            <PgwidgetProgressLeft
              {...{ animationDuration, timeInMilliSeconds }}
            />
          </PgwidgetBarL>

          <PgwidgetBarR>
            <PgwidgetProgressRight
              {...{ animationDuration, timeInMilliSeconds }}
            />
          </PgwidgetBarR>
        </Circle>
...
const PgwidgetProgressLeft = styled.div`
  ...
  animation: ${(props) =>
    props.timeInMilliSeconds > 0
      ? css`
          ${left} ${props.animationDuration}s linear both
        `
      : ""};
`;
...
const PgwidgetProgressRight = styled.div`
  ...
  animation: ${(props) =>
    props.timeInMilliSeconds > 0
      ? css`
          ${right} ${props.animationDuration}s linear both
        `
      : ""};
